...
function IconArrowRightCircled({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
...
fill="#000000" stroke="none">
<path d="M1658 3240 c-186 -17 -360 -68 -526 -155 -145 -76 -248 -153 -365
-275 -189 -196 -306 -411 -368 -680 -29 -121 -36 -383 -15 -510 51 -312 181
-566 400 -786 203 -202 436 -329 718 -391 118 -25 438 -26 556 0 579 125 1015
572 1118 1147 22 125 23 354 1 477 -130 729 -791 1239 -1519 1173z m217 -280
c271 -26 487 -122 682 -303 383 -358 469 -950 204 -1397 -156 -262 -404 -449
-699 -527 -132 -35 -346 -43 -477 -18 -474 88 -839 455 -921 926 -23 135 -15
339 20 474 35 136 126 315 216 426 192 238 471 389 770 418 47 5 87 9 90 10 3
0 55 -4 115 -9z"/>
<path d="M1780 2182 l0 -212 -280 0 -280 0 0 -140 0 -140 280 0 280 0 0 -212
0 -213 282 283 283 282 -283 282 -282 283 0 -213z"/>
</g>
</svg>
  )
}
